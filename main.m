...
for i = 401 %201-50:201+50
    for j = 401 %201-50:201+50
        for angle = 1:361
            ...
            dis = sqrt(new_positions2(angle,1).^2 + new_positions2(angle,2).^2);
...
%%
figure(2)
imagesc(abs(hilbert(post_recon)))
%%
